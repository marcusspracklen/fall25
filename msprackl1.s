...
# Due: 09/25/25 (Modified: 10/08/25)
# Class: CS24
...
main:
        ...
        la t0, input_prompt     # load address into t0
        sout t0                 # print t0
...
loop:
        la t0, input_prompt     # load adress of a string into t0
        sout t0                 # display the string whose address is in t0
        ...
        bge x8, x5, no_update   # if x8 >= x5 then make it new max
...
.data
input_prompt:        .asciz "Please input an integer!: "
